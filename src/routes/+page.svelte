	...
	<section class="relative mx-auto max-w-7xl px-6 py-24">
		<ScrollReveal direction="scale" duration={800} threshold={0.2}>
			...
			>
				...
				<div class="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-transparent opacity-0 transition-all duration-1000 group-hover:from-green-200/60 group-hover:via-green-100/60 group-hover:to-green-200/60 group-hover:opacity-100"></div>
				<div class="absolute inset-0 animate-liquid-slow bg-gradient-to-tr from-transparent via-transparent to-transparent opacity-0 transition-all duration-1000 group-hover:from-green-100/50 group-hover:via-green-200/50 group-hover:to-green-100/50 group-hover:opacity-100"></div>
			...
			>
				<!-- Animated liquid gradient background -->
				<div class="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-transparent opacity-0 transition-all duration-1000 group-hover:from-amber-200/60 group-hover:via-amber-100/60 group-hover:to-amber-200/60 group-hover:opacity-100"></div>
				<div class="absolute inset-0 animate-liquid-slow bg-gradient-to-tr from-transparent via-transparent to-transparent opacity-0 transition-all duration-1000 group-hover:from-amber-100/50 group-hover:via-amber-200/50 group-hover:to-amber-100/50 group-hover:opacity-100"></div>
